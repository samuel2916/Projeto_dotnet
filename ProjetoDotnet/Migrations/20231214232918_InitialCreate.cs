        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotavendasId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemNotaDeVenda", x => new { x.ItemsId, x.NotavendasId });
                    table.ForeignKey(
                        name: "FK_ItemNotaDeVenda_Items_ItemsId",
                        column: x => x.ItemsId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemNotaDeVenda_NotaDeVendas_NotavendasId",
                        column: x => x.NotavendasId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemNotaDeVenda_NotavendasId",
